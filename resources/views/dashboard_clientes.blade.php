    ...
    @foreach($clientes as $cliente)
        <div class="employee-card" 
            ...
            <div class="employee-photo" style="cursor: pointer;">
                <img src="{{ asset('imagens/carteira-de-identidade.png') }}" alt="Imagem Cliente">
            </div>
        ...
        <div class="modal-body">
            <div class="form-wrapper"> <!-- Wrapper para organizar o layout -->
                ...
                <form action="{{ route('clientes.create') }}" method="POST" class="employee-details">
                    ...
                    <input type="text" name='descricao' placeholder="Descrição do Cliente" class="address-full-width" />
...
<div class="modal-view-cliente" id="modalVisualizarCliente">
    <div class="modal-content-view">
        ...
        <div class="modal-body-view">
            <div class="foto-view">
                <img src="{{ asset('imagens/funcionario.png') }}" alt="View Cliente" class="view-cliente">
            </div>
            <div class="detalhes-view">
                ...
                <p><strong>Descrição do Cliente:</strong> <span id="viewDescricaoCliente">Descricao</span></p>
            </div>
        </div>
    </div>
</div>
